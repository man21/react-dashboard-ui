...
function MultiRowTD(props) {
  ...
  return (
    <Box ml={props.marginLeft} style={{ display: 'inline-block' }}>
      <div className={classes.first}>{props.first}</div>
      <div className={classes.second}>{props.second}</div>
    </Box>
  )
}
      ...
      <Grid item xs={12}>
        <Toolbar className={classes.toolbar}>
          ...
          <Paper component="form" className={classes_search.root}>
            ...
            />
            <IconButton
              className={classes_search.iconButton}
              aria-label="search"
            >
              <SearchIcon />
            </IconButton>
          ...
          <div className={classes.toolbarWrapper}>
            <Typography className={classes.navbar}>
              <Link
                href="#"
                className={selectedMenu == 'week' ? classes.navbarSelected : ''}
                onClick={(event) => {
              ...
              <Link
                href="#"
                className={
                  selectedMenu == 'month' ? classes.navbarSelected : ''
                }
                onClick={(event) => {
              ...
              <Link
                href="#"
                className={selectedMenu == 'year' ? classes.navbarSelected : ''}
                onClick={(event) => {
                ...
                <StyledTableRow key={index}>
                  <StyledTableCell component="th" scope="row">
                    <Box display={'flex'}>
                      ...
                      <MultiRowTD
                        first={row.col1}
                        second={'jane.cooper@example.com'}
                        marginLeft={2}
                      />
                    </Box>
                  </StyledTableCell>
                  <StyledTableCell>
                    <MultiRowTD
                      first={'Regional Paradigm Technician'}
                      second={'Optimization'}
                      marginLeft={0}
                    />
                  </StyledTableCell>
